...
class Monitor:
    def __init__(self, bot_pid, task_number, proxy):
        ...
        self.product_page = f"https://moredrops.cl/p/{self.size_pid}"
    ...
    def __str__(self):
        return f"Drops Monitor for size {self.size} and PID {self.pid}"
    ...
    def send_webhook(self):
        ...
        # set footer
        embed.set_footer(text='Rebel Notify Drops Monitor')

        # set timestamp (default is now)
        embed.set_timestamp()
        embed.set_thumbnail(url="https://moredrops.cl" + self.product_image)
        # add fields to embed
    ...
    def empty_cart(self):
        ...
        emptyCartPOST = self.s.post(
            "https://moredrops.cl/cart/entry/execute/REMOVE",
            data={
            ...
            headers={
                ...
                "referer": "https://moredrops.cl/cart",
                "upgrade-insecure-requests": "1",
                "user-agent": self.user_agent
            },
            proxies=self.proxy
...
if __name__ == '__main__':
    try:
        ...
        for taskNumber in range(len(pids)):
            ...
            threading.Thread(target=monitor_instance.Drops, args=()).start()
            time.sleep(2)
